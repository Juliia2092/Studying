...
class Frigate(Ship):
    ...
    @staticmethod
    def fuel_f():
        user_input = int(input('The ship needs fuel. How many fuel would you refuel?: '))
        if user_input <= frigate.volume:
            print('The ship is refueled!')
        else:
            print('Too much fuel!')
...
class Destroyer(Ship):
    ...
    def fuel_d():
        user_input = int(input('The ship needs fuel. How many fuel would you refuel?: '))
        if user_input <= destroyer.volume:
            print('The ship is refueled!')
        else:
            print('Too much fuel!')
